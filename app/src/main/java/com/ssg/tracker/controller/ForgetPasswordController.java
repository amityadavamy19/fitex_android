...
import com.ssg.tracker.fragments.ForgetPasswordVerificationfragment;
...
import com.ssg.tracker.fragments.ResetPasswordfragment;
...
public class ForgetPasswordController extends IntroActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Slide loginSlide = new FragmentSlide.Builder()
                ...
                .fragment(ForgetPasswordVerificationfragment.newInstance())
                .build();
        addSlide(loginSlide);
        // otp selction
